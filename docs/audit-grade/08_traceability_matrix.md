...
| PX-07 | FX histórico para PnL CLP | `fx_rate_raw` oficial BCCh y `fx_rates_pit` PIT implementados; falta backfill/audit live | WP-04/05 | FX PIT fixture | IMPLEMENTED_UNVERIFIED |
